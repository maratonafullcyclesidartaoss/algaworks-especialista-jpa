...
insert into produto (id, nome, preco, data_criacao, descricao) values (5, 'Macbook Pro', 13500.0, sysdate(), 'O melhor notebook.');
insert into produto (id, nome, preco, data_criacao, descricao) values (6, 'Microfone de Lapela', 59.0, sysdate(), 'O melhor microfone.');
...
insert into pedido (id, cliente_id, data_criacao, valor_total, status) values (1, 1, date_sub(sysdate(), interval 32 day), 2398.0, 'AGUARDANDO');
insert into pedido (id, cliente_id, data_criacao, valor_total, status) values (2, 1, date_sub(sysdate(), interval 5 day), 499.0, 'AGUARDANDO');
insert into pedido (id, cliente_id, data_criacao, valor_total, status) values (3, 1, date_sub(sysdate(), interval 4 day), 3500.0, 'PAGO');
insert into pedido (id, cliente_id, data_criacao, valor_total, status) values (4, 2, date_sub(sysdate(), interval 2 day), 499.0, 'PAGO');
insert into pedido (id, cliente_id, data_criacao, valor_total, status) values (5, 1, date_sub(sysdate(), interval 2 day), 799.0, 'PAGO');
insert into pedido (id, cliente_id, data_criacao, valor_total, status) values (6, 2, sysdate(), 799.0, 'AGUARDANDO');
insert into pedido (id, cliente_id, data_criacao, valor_total, status) values (7, 2, sysdate(), 50.0, 'AGUARDANDO');
...
insert into item_pedido (pedido_id, produto_id, preco_produto, quantidade) values (7, 6, 50, 1);
...
insert into pagamento (pedido_id, status, tipo_pagamento, numero_cartao, codigo_barras, data_vencimento) values (3, 'RECEBIDO', 'boleto', null, '8910', date_sub(sysdate(), interval 4 day));
insert into pagamento (pedido_id, status, tipo_pagamento, numero_cartao, codigo_barras) values (4, 'PROCESSANDO', 'cartao', '5236846857859897', null);
